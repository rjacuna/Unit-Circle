...
(def tex2svg "/usr/local/bin/tex2svg")
...
(def formulas [{:n "tau"
               ...
               {:n "key1"
                :f "e^{i{\\color{green}\\theta}} = {\\color{red}\\cos{\\color{green}\\theta}} + i {\\color{blue}\\sin{\\color{green}\\theta}}"}
               {:n "key2"
                :f "\\quad \\mapsto\\left[\\hspace{3em} \\right]"}])
